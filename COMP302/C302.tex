...
\label{sec:org19bd9a7}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orgc313500}
\begin{itemize}
...
\label{sec:org3a817e3}
\subsection{Functions}
\label{sec:org534ab6b}
\begin{itemize}
...
\label{sec:org3fef1e1}
\subsubsection{Playing cards}
\label{sec:org1046181}
\begin{itemize}
...
\label{sec:org73bea24}
\begin{enumerate}
\item Step 1
\label{sec:org10679dc}
...
\end{itemize}
\item Theorem
\label{sec:org5a6b0e1}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orga7549d0}
...
\label{sec:org6faa1d6}
\subsection{Structural Induction}
\label{sec:org165bc9b}
\begin{itemize}
...
\label{sec:org2c7b464}
\subsection{Higher-order functions}
\label{sec:org4a76d20}
\begin{itemize}
...
\label{sec:orgf0db7e1}
\subsection{Lambda-Calculus}
\label{sec:org6569437}
\begin{itemize}
...
\label{sec:org6f378be}
\subsection{Warm up}
\label{sec:orga3e7dc6}
...
\label{sec:orgc4dc1e5}
\subsection{Demo}
\label{sec:org3dd7dba}
\begin{itemize}
...
\label{sec:org3efcd2a}
\subsection{Exceptions}
\label{sec:org0b4418a}
\begin{itemize}
