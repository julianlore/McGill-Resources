...
\label{sec:org9539a03}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org7d262de}
\begin{itemize}
...
\label{sec:orgb608225}
\subsection{Functions}
\label{sec:org6f143ed}
\begin{itemize}
...
\label{sec:org4c479e5}
\subsubsection{Playing cards}
\label{sec:org4a3b7bc}
\begin{itemize}
...
\label{sec:org3a6624a}
\begin{enumerate}
\item Step 1
\label{sec:orgc37092b}
...
\end{itemize}
\item Theorem
\label{sec:org5b877ec}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org355332b}
...
\label{sec:org0a2ed98}
\subsection{Structural Induction}
\label{sec:orgad9d333}
\begin{itemize}
...
\label{sec:org1dc68aa}
\subsection{Higher-order functions}
\label{sec:orgf23f44f}
\begin{itemize}
...
\label{sec:orgdca36b5}
\subsection{Lambda-Calculus}
\label{sec:org3a9700f}
\begin{itemize}
