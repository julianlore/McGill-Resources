...
\label{sec:org1934b7b}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orga71eca4}
\begin{itemize}
...
\label{sec:orgcf8a19b}
\subsection{Functions}
\label{sec:orgd401c69}
\begin{itemize}
...
\label{sec:org0965b03}
\subsubsection{Playing cards}
\label{sec:org9bda9e6}
\begin{itemize}
...
\label{sec:org43bcdd2}
\begin{enumerate}
\item Step 1
\label{sec:org1bec791}
...
\end{itemize}
\item Theorem
\label{sec:orga1d53b1}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgf9a2451}
...
\label{sec:orgf3e97f4}
\subsection{Structural Induction}
\label{sec:orge347334}
\begin{itemize}
...
\label{sec:orgac78f68}
\subsection{Lambda-Calculus}
\label{sec:org726d46e}
\begin{itemize}
...
\label{sec:orgb1326db}
\subsection{Warm up}
\label{sec:orgf6d0725}
...
\label{sec:orgb187e51}
\subsection{Demo}
\label{sec:orgb11e29a}
\begin{itemize}
...
\label{sec:orgf6ad131}
\subsection{Exceptions}
\label{sec:org0f419f6}
\begin{itemize}
...
\label{sec:org3168ef0}
\subsection{Backtracking}
\label{sec:org13125d4}
\begin{itemize}
...
\label{sec:org68909d8}
\subsection{Modules}
\label{sec:org8e3e080}
Primary Benefits:
\begin{itemize}
...
\label{sec:org694f334}
\subsection{More on Modules}
\label{sec:org346f612}
\begin{itemize}
...
\label{sec:org3450c34}
\subsection{Continuations}
\label{sec:org4e57dc8}
...
\label{sec:orgd6b6dec}
\subsection{Continuation recap}
\label{sec:org89d2f4b}
\begin{itemize}
...
\label{sec:org9ad4265}
\subsection{Regular expressions}
\label{sec:org2d6952e}
...
\label{sec:org9fa5beb}
\subsection{Lazy Programming}
\label{sec:org7c8fd88}
\subsubsection{Eager vs Lazy}
\label{sec:org2a1e608}
\begin{itemize}
...
\label{sec:org025f86e}
\subsection{Demo}
\label{sec:org5b94cb0}
\begin{verbatim}
...
\label{sec:orga530d88}
\subsection{Designing our own language}
\label{sec:org9b4c435}
...
\label{sec:org68d79ed}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:orgfc0c0af}
\begin{itemize}
\item Types approximate runtime behavior
