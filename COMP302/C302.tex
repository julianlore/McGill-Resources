...
\label{sec:org281f1b5}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org80defde}
\begin{itemize}
...
\label{sec:org46978ef}
\subsection{Functions}
\label{sec:org637e6ab}
\begin{itemize}
...
\label{sec:orgf75e755}
\subsubsection{Playing cards}
\label{sec:orgcc86196}
\begin{itemize}
...
\label{sec:org3ae4630}
\begin{enumerate}
\item Step 1
\label{sec:orgd19d0ea}
...
\end{itemize}
\item Theorem
\label{sec:org1eae892}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgbf07f8a}
...
\label{sec:orgb2fb57b}
\subsection{Structural Induction}
\label{sec:org617959a}
\begin{itemize}
...
\label{sec:org611b51a}
\subsection{Higher-order functions}
\label{sec:org2b2d0ba}
\begin{itemize}
...
\label{sec:org3cc94a3}
\subsection{Lambda-Calculus}
\label{sec:org6628cb8}
\begin{itemize}
...
\label{sec:orgccf680d}
\subsection{Warm up}
\label{sec:orgf66b16c}
...
\label{sec:orgf0c81a6}
\subsection{Demo}
\label{sec:org34b6a1e}
\begin{itemize}
...
\label{sec:orgcbde3e3}
\subsection{Exceptions}
\label{sec:org941d1f7}
\begin{itemize}
...
\label{sec:orgd55bb73}
\subsection{Backtracking}
\label{sec:org19944f8}
\begin{itemize}
...
\label{sec:org43d2923}
\subsection{Modules}
\label{sec:orgb1cf151}
Primary Benefits:
\begin{itemize}
...
\label{sec:org25e5d7a}
\subsection{More on Modules}
\label{sec:org3395e29}
\begin{itemize}
...
\label{sec:orgc009ed3}
\subsection{Continuations}
\label{sec:org75a6379}
...
\label{sec:org4bbc183}
\subsection{Continuation recap}
\label{sec:org9399954}
\begin{itemize}
...
\label{sec:org9064595}
\subsection{Regular expressions}
\label{sec:orgdfcd3f7}
