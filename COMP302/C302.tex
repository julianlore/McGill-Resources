...
\label{sec:org00e5e62}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org607bd47}
\begin{itemize}
...
\label{sec:orgcc919df}
\subsection{Functions}
\label{sec:orga7df2f5}
\begin{itemize}
...
\label{sec:orga438250}
\subsubsection{Playing cards}
\label{sec:org187d674}
\begin{itemize}
...
\label{sec:org03ba45f}
\begin{enumerate}
\item Step 1
\label{sec:orgac58980}
...
\end{itemize}
\item Theorem
\label{sec:org4285925}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org338a173}
...
\label{sec:orgff66352}
\subsection{Structural Induction}
\label{sec:org34ea0b1}
\begin{itemize}
...
\label{sec:orgb870a45}
\subsection{Higher-order functions}
\label{sec:org7eaf7d0}
\begin{itemize}
...
\label{sec:orgcf8b253}
\subsection{Lambda-Calculus}
\label{sec:org30a4c13}
\begin{itemize}
...
\label{sec:orgadd5518}
\subsection{Warm up}
\label{sec:org2d57a38}
...
\label{sec:org4f898c6}
\subsection{Demo}
\label{sec:org179afeb}
\begin{itemize}
...
\label{sec:org238373d}
\subsection{Exceptions}
\label{sec:org131ad0a}
\begin{itemize}
...
\label{sec:org98b4cf4}
\subsection{Backtracking}
\label{sec:orgcf91739}
\begin{itemize}
...
\label{sec:org94c9859}
\subsection{Modules}
\label{sec:org27858b0}
Primary Benefits:
\begin{itemize}
...
\label{sec:org8470093}
\subsection{More on Modules}
\label{sec:org3fe1f16}
\begin{itemize}
...
\label{sec:orgc6226fc}
\subsection{Continuations}
\label{sec:orge888f5e}
...
\label{sec:orgeebd1df}
\subsection{Continuation recap}
\label{sec:org574d49e}
\begin{itemize}
...
\label{sec:org983372b}
\subsection{Regular expressions}
\label{sec:org0178b8c}
...
\label{sec:org5baddc1}
\subsection{Lazy Programming}
\label{sec:org29487f1}
\subsubsection{Eager vs Lazy}
\label{sec:org2364bc3}
\begin{itemize}
...
\label{sec:org16f4fb3}
\subsection{Demo}
\label{sec:org4c13dd4}
\begin{verbatim}
...
\label{sec:orgb603b57}
\subsection{Designing our own language}
\label{sec:orgd86cdfa}
...
\label{sec:orgc6d438e}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:org0665229}
\begin{itemize}
\item Types approximate runtime behavior
...
\label{sec:org082285d}
Continuation from last class.
\subsection{Substitution}
\label{sec:org3b5947c}
\begin{itemize}
...
\label{sec:orgc3a4aaa}
\subsection{T-FN rule}
\label{sec:org40840be}
...
\label{sec:orgc784761}
\subsection{Type Inference}
\label{sec:orgb19265f}
...
\label{sec:org9dd2c22}
\subsection{How to solve constraints?}
\label{sec:orgc59a455}
