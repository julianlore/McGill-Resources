...
\label{sec:org475b909}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org7dd5453}
\begin{itemize}
...
\label{sec:orgf712f3f}
\subsection{Functions}
\label{sec:org30ab670}
\begin{itemize}
...
\label{sec:org308bc92}
\subsubsection{Playing cards}
\label{sec:orgd94e750}
\begin{itemize}
...
\label{sec:org909788c}
\begin{enumerate}
\item Step 1
\label{sec:orgda2b6e2}
...
\end{itemize}
\item Theorem
\label{sec:orgf3cc481}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orge0038b7}
...
\label{sec:orge1aec54}
\subsection{Structural Induction}
\label{sec:orgbeee341}
\begin{itemize}
...
\label{sec:org49fc277}
\subsection{Higher-order functions}
\label{sec:orgceed6e5}
\begin{itemize}
...
\label{sec:org54fa6a7}
\subsection{Lambda-Calculus}
\label{sec:org0f0db90}
\begin{itemize}
...
\label{sec:orgca4aa73}
\subsection{Warm up}
\label{sec:org5e57ad6}
...
\label{sec:orgf639b74}
\subsection{Demo}
\label{sec:orgf8371cf}
\begin{itemize}
...
\label{sec:orgc864ff3}
\subsection{Exceptions}
\label{sec:org7030b06}
\begin{itemize}
...
\label{sec:org0fa15f8}
\subsection{Backtracking}
\label{sec:orgf133611}
\begin{itemize}
...
\label{sec:orgfa62276}
\subsection{Modules}
\label{sec:orgfa68b4d}
Primary Benefits:
\begin{itemize}
...
\label{sec:orga8be5a3}
\subsection{More on Modules}
\label{sec:org598276d}
\begin{itemize}
...
\label{sec:org6a9ab64}
\subsection{Continuations}
\label{sec:org9088fea}
...
\label{sec:org9bb7f8e}
\subsection{Continuation recap}
\label{sec:orgb94a5ec}
\begin{itemize}
...
\label{sec:org5d0d9b1}
\subsection{Regular expressions}
\label{sec:orgc3c9ed6}
