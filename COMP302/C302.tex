...
\label{sec:org54a1a33}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org0f9bc36}
\begin{itemize}
...
\label{sec:org302885e}
\subsection{Functions}
\label{sec:orgcba7d15}
\begin{itemize}
...
\label{sec:orgc39792d}
\subsubsection{Playing cards}
\label{sec:orgc912eef}
\begin{itemize}
...
\label{sec:orged6d1b4}
\begin{enumerate}
\item Step 1
\label{sec:org0469537}
...
\end{itemize}
\item Theorem
\label{sec:org14301f0}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orge1036e9}
...
\label{sec:org1206999}
\subsection{Structural Induction}
\label{sec:orgadbd55a}
\begin{itemize}
...
\label{sec:org715fd38}
\subsection{Higher-order functions}
\label{sec:orge666af5}
\begin{itemize}
...
\label{sec:org2397e93}
\subsection{Lambda-Calculus}
\label{sec:org0c62769}
\begin{itemize}
...
\label{sec:orga48bdd3}
\subsection{Warm up}
\label{sec:org2c4fc8f}
...
\label{sec:orgf849d9f}
\subsection{Demo}
\label{sec:org1f758e5}
\begin{itemize}
...
\label{sec:orgfde7eaa}
\subsection{Exceptions}
\label{sec:orgbe1354d}
\begin{itemize}
...
\label{sec:orgde11705}
\subsection{Backtracking}
\label{sec:org862b04d}
\begin{itemize}
...
\label{sec:org279b950}
\subsection{Modules}
\label{sec:orgab25dfe}
Primary Benefits:
\begin{itemize}
...
\label{sec:orgc571e14}
\subsection{More on Modules}
\label{sec:org07f032f}
\begin{itemize}
...
\label{sec:orga992959}
\subsection{Continuations}
\label{sec:org53375c3}
...
\label{sec:orgc1254d9}
\subsection{Continuation recap}
\label{sec:orgd81ccc7}
\begin{itemize}
...
\label{sec:org35c2229}
\subsection{Regular expressions}
\label{sec:orgd443e09}
...
\label{sec:org331db2f}
\subsection{Lazy Programming}
\label{sec:org7e53ae8}
\subsubsection{Eager vs Lazy}
\label{sec:orga9676ef}
\begin{itemize}
...
\label{sec:org2b3a320}
\subsection{Demo}
\label{sec:orgf9c8062}
\begin{verbatim}
...
\label{sec:org7ef7985}
\subsection{Designing our own language}
\label{sec:org52f1c44}
...
\label{sec:orge8a15f2}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:org80463dd}
\begin{itemize}
\item Types approximate runtime behavior
