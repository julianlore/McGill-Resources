...
\label{sec:org5ad3e78}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org943776d}
\begin{itemize}
...
\label{sec:org535d027}
\subsection{Functions}
\label{sec:orgdd9598d}
\begin{itemize}
...
\label{sec:org4f10c7c}
\subsubsection{Playing cards}
\label{sec:org006e19d}
\begin{itemize}
...
\label{sec:org20545de}
\begin{enumerate}
\item Step 1
\label{sec:org785d6c7}
...
\end{itemize}
\item Theorem
\label{sec:org53ddf42}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org66a340a}
...
\label{sec:orgbce835a}
\subsection{Structural Induction}
\label{sec:org0580fa8}
\begin{itemize}
...
\label{sec:org2a690cf}
\subsection{Higher-order functions}
\label{sec:org5a5c5f6}
\begin{itemize}
...
\label{sec:org7da494e}
\subsection{Lambda-Calculus}
\label{sec:org7e41317}
\begin{itemize}
...
\label{sec:orga336b03}
\subsection{Warm up}
\label{sec:orgfa7a579}
...
\label{sec:org6dda8d1}
\subsection{Demo}
\label{sec:org533a342}
\begin{itemize}
...
\label{sec:orgc4e0b7f}
\subsection{Exceptions}
\label{sec:org36b31ea}
\begin{itemize}
...
\label{sec:org1fa390c}
\subsection{Backtracking}
\label{sec:org55c9824}
\begin{itemize}
...
\label{sec:org1c488cc}
\subsection{Modules}
\label{sec:org351b106}
Primary Benefits:
\begin{itemize}
