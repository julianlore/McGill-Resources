...
\label{sec:org2f2434c}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org383e3a9}
\begin{itemize}
...
\label{sec:org98f11c4}
\subsection{Functions}
\label{sec:orgdc6e0a9}
\begin{itemize}
...
\label{sec:orge3c1302}
\subsubsection{Playing cards}
\label{sec:orga3594f5}
\begin{itemize}
...
\label{sec:orga6941fd}
\begin{enumerate}
\item Step 1
\label{sec:org1531570}
...
\end{itemize}
\item Theorem
\label{sec:org5852813}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org83d6fad}
...
\label{sec:org9477333}
\subsection{Structural Induction}
\label{sec:orgf18a3d4}
\begin{itemize}
...
\label{sec:org40a3bbf}
\subsection{Higher-order functions}
\label{sec:org64314e0}
\begin{itemize}
...
\label{sec:org749abfe}
\subsection{Lambda-Calculus}
\label{sec:org4177ac4}
\begin{itemize}
...
\label{sec:org9d46904}
\subsection{Warm up}
\label{sec:org264d9ad}
...
\label{sec:org901de4e}
\subsection{Demo}
\label{sec:org9fccf14}
\begin{itemize}
...
\label{sec:org3aa6ab4}
\subsection{Exceptions}
\label{sec:orgef44162}
\begin{itemize}
...
\label{sec:orgc04ae25}
\subsection{Backtracking}
\label{sec:org8d3a34e}
\begin{itemize}
...
\label{sec:orgc9f13f4}
\subsection{Modules}
\label{sec:org8f57a92}
Primary Benefits:
\begin{itemize}
...
\label{sec:orgbd6da5b}
\subsection{More on Modules}
\label{sec:org4923c1f}
\begin{itemize}
...
\label{sec:orgdfdf359}
\subsection{Continuations}
\label{sec:org3a1f968}
...
\label{sec:org7e1dd21}
\subsection{Continuation recap}
\label{sec:orgc4a7f4f}
\begin{itemize}
...
\label{sec:org054dfde}
\subsection{Regular expressions}
\label{sec:orgbcc638b}
...
\label{sec:org14560f3}
\subsection{Lazy Programming}
\label{sec:orgb90d73c}
\subsubsection{Eager vs Lazy}
\label{sec:orgab59461}
\begin{itemize}
...
\label{sec:orged2fe27}
\subsection{Demo}
\label{sec:orgfbf9622}
\begin{verbatim}
