...
\label{sec:org34cdc2e}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orgb988f3b}
\begin{itemize}
...
\label{sec:orgfc3bdca}
\subsection{Functions}
\label{sec:orgd03b1f5}
\begin{itemize}
...
\label{sec:org826978b}
\subsubsection{Playing cards}
\label{sec:orga3543ce}
\begin{itemize}
...
\label{sec:orgd6730da}
\begin{enumerate}
\item Step 1
\label{sec:org4d307de}
...
\end{itemize}
\item Theorem
\label{sec:org65fc67b}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org6693709}
...
\label{sec:org28c34c4}
\subsection{Structural Induction}
\label{sec:org6bac050}
\begin{itemize}
...
\label{sec:org4532be7}
\subsection{Higher-order functions}
\label{sec:orgb29c1c6}
\begin{itemize}
...
\label{sec:orgff522f3}
\subsection{Lambda-Calculus}
\label{sec:orgb2a7a41}
\begin{itemize}
...
\label{sec:org7b80a8e}
\subsection{Warm up}
\label{sec:org3ff9f88}
...
\label{sec:org67fda5c}
\subsection{Demo}
\label{sec:org6c8195e}
\begin{itemize}
...
\label{sec:org38a3791}
\subsection{Exceptions}
\label{sec:orge6346a5}
\begin{itemize}
...
\label{sec:orgba38945}
\subsection{Backtracking}
\label{sec:org9387c67}
\begin{itemize}
...
\label{sec:orgde8b9f3}
\subsection{Modules}
\label{sec:org6a6a4b3}
Primary Benefits:
\begin{itemize}
...
\label{sec:orgda6d17f}
\subsection{More on Modules}
\label{sec:orgdadf1d2}
\begin{itemize}
...
\label{sec:orgf7560be}
\subsection{Continuations}
\label{sec:org5234833}
...
\label{sec:orgba78ce4}
\subsection{Continuation recap}
\label{sec:org3db48a3}
\begin{itemize}
...
\label{sec:orgafcb2e1}
\subsection{Regular expressions}
\label{sec:org2e2f3db}
...
\label{sec:org39532b0}
\subsection{Lazy Programming}
\label{sec:orgb732f22}
\subsubsection{Eager vs Lazy}
\label{sec:orgd3a16cc}
\begin{itemize}
...
\label{sec:org6f62472}
\subsection{Demo}
\label{sec:orgecaf5a3}
\begin{verbatim}
...
\label{sec:org1b01751}
\subsection{Designing our own language}
\label{sec:org99bec2b}
...
\label{sec:orga07c546}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:org8725669}
\begin{itemize}
\item Types approximate runtime behavior
...
\label{sec:org57c8ac8}
Continuation from last class.
\subsection{Substitution}
\label{sec:org1fb3a7d}
\begin{itemize}
...
\label{sec:org0c07d56}
\subsection{T-FN rule}
\label{sec:orgde9dbbe}
...
\label{sec:org9bc2be3}
\subsection{Type Inference}
\label{sec:orgcdd67b4}
...
\label{sec:org6ddb1b8}
\subsection{How to solve constraints?}
\label{sec:orgac59082}
...
\label{sec:orgb2e0a8d}
\subsection{Subtyping}
\label{sec:orgd5526f6}
\begin{itemize}
...
\label{sec:orga3c9433}
\subsection{References}
\label{sec:org37c089b}
\begin{itemize}
