...
\label{sec:org58210e1}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org360099a}
\begin{itemize}
...
\label{sec:orgc9a6ed6}
\subsection{Functions}
\label{sec:orgf183aa7}
\begin{itemize}
...
\label{sec:orgc9182e8}
\subsubsection{Playing cards}
\label{sec:org30a2825}
\begin{itemize}
...
\label{sec:org21ef32e}
\begin{enumerate}
\item Step 1
\label{sec:orgca93586}
...
\end{itemize}
\item Theorem
\label{sec:orgc28790d}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgb294c2e}
...
\label{sec:orge4d29c9}
\subsection{Structural Induction}
\label{sec:orga490537}
\begin{itemize}
...
\label{sec:org57486ed}
\subsection{Higher-order functions}
\label{sec:orgee1eb67}
\begin{itemize}
...
\label{sec:org23a8d7e}
\subsection{Lambda-Calculus}
\label{sec:orgad7242c}
\begin{itemize}
...
\label{sec:org31a97e5}
\subsection{Warm up}
\label{sec:orgc666bfa}
...
\label{sec:org74f9691}
\subsection{Demo}
\label{sec:orgd3491a5}
\begin{itemize}
...
\label{sec:org4efe663}
\subsection{Exceptions}
\label{sec:orgb7e41b3}
\begin{itemize}
...
\label{sec:org96632bc}
\subsection{Backtracking}
\label{sec:org0f572ae}
\begin{itemize}
...
\label{sec:orgd27be5c}
\subsection{Modules}
\label{sec:org9733a8f}
Primary Benefits:
\begin{itemize}
...
\label{sec:orga03fec9}
\subsection{More on Modules}
\label{sec:org71080fa}
\begin{itemize}
...
\label{sec:org2d18a5a}
\subsection{Continuations}
\label{sec:org446babe}
...
\label{sec:orgb230798}
\subsection{Continuation recap}
\label{sec:org2301129}
\begin{itemize}
...
\label{sec:org8e3198b}
\subsection{Regular expressions}
\label{sec:orgf107039}
...
\label{sec:org58e6b71}
\subsection{Lazy Programming}
\label{sec:org1b45f43}
\subsubsection{Eager vs Lazy}
\label{sec:org42816f7}
\begin{itemize}
...
\label{sec:org2c06c51}
\subsection{Demo}
\label{sec:org142d1f0}
\begin{verbatim}
...
\label{sec:org035ea8f}
\subsection{Designing our own language}
\label{sec:org9c40c07}
...
\label{sec:org70933c5}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:orgb16d26a}
\begin{itemize}
\item Types approximate runtime behavior
...
\label{sec:org47d980a}
Continuation from last class.
\subsection{Substitution}
\label{sec:org01be7d5}
\begin{itemize}
...
\label{sec:orgad87871}
\subsection{T-FN rule}
\label{sec:org8d0aa0b}
...
\label{sec:org967f8ca}
\subsection{Type Inference}
\label{sec:orgbdab718}
