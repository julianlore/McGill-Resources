...
\label{sec:orgba212b3}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org3d6e0d8}
\begin{itemize}
...
\label{sec:orgb61d8b9}
\subsection{Functions}
\label{sec:orgd1114d4}
\begin{itemize}
...
\label{sec:org72d9705}
\subsubsection{Playing cards}
\label{sec:org9ca5d9a}
\begin{itemize}
...
\label{sec:orgb696669}
\begin{enumerate}
\item Step 1
\label{sec:orgdafd854}
...
\end{itemize}
\item Theorem
\label{sec:orgbac5123}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org0a7f2aa}
...
\label{sec:org85b25b9}
\subsection{Structural Induction}
\label{sec:orge10ea7e}
\begin{itemize}
...
\label{sec:org19d27b0}
\subsection{Higher-order functions}
\label{sec:org593b26d}
\begin{itemize}
...
\label{sec:org76ebb30}
\subsection{Lambda-Calculus}
\label{sec:orgfc80d44}
\begin{itemize}
...
\label{sec:orgf04d4f9}
\subsection{Warm up}
\label{sec:orgf8fe61b}
...
\label{sec:orgbd58e43}
\subsection{Demo}
\label{sec:org119f38f}
\begin{itemize}
...
\label{sec:orga5d4d49}
\subsection{Exceptions}
\label{sec:org8f2ce44}
\begin{itemize}
...
\label{sec:org6d2b0c9}
\subsection{Backtracking}
\label{sec:org7534587}
\begin{itemize}
...
\label{sec:orgbe9f142}
\subsection{Modules}
\label{sec:orgcd4ad79}
Primary Benefits:
\begin{itemize}
...
\label{sec:org6e733fc}
\subsection{More on Modules}
\label{sec:orga3a8ac6}
\begin{itemize}
...
\label{sec:org21f852e}
\subsection{Continuations}
\label{sec:org5cef3c4}
...
\label{sec:orge555ad5}
\subsection{Continuation recap}
\label{sec:org05ca527}
\begin{itemize}
...
\label{sec:org4fc77c3}
\subsection{Regular expressions}
\label{sec:org1eebb54}
...
\label{sec:org6864f7c}
\subsection{Lazy Programming}
\label{sec:org7ec5d5c}
\subsubsection{Eager vs Lazy}
\label{sec:orgeb26915}
\begin{itemize}
