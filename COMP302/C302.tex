...
\label{sec:org1433c8e}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orgf9454e6}
\begin{itemize}
...
\label{sec:org8e59e67}
\subsection{Functions}
\label{sec:org18cf86f}
\begin{itemize}
...
\label{sec:org5c03b26}
\subsubsection{Playing cards}
\label{sec:org19686c2}
\begin{itemize}
...
\label{sec:org90a9e05}
\begin{enumerate}
\item Step 1
\label{sec:org2dbd736}
...
\end{itemize}
\item Theorem
\label{sec:org470b5f4}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org5e5ae9c}
...
\label{sec:org79b54ab}
\subsection{Structural Induction}
\label{sec:orgb787aad}
\begin{itemize}
...
\label{sec:org1271209}
\subsection{Higher-order functions}
\label{sec:orgd1247e6}
\begin{itemize}
...
\label{sec:org15612ce}
\subsection{Lambda-Calculus}
\label{sec:org3a94d99}
\begin{itemize}
...
\label{sec:orgb9090d8}
\subsection{Warm up}
\label{sec:orgde402b5}
...
\label{sec:org960180e}
\subsection{Demo}
\label{sec:org13b6819}
\begin{itemize}
