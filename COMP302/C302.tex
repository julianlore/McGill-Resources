...
\label{sec:org21466d1}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orgbf02cab}
\begin{itemize}
...
\label{sec:org1fa4355}
\subsection{Functions}
\label{sec:org730a86b}
\begin{itemize}
...
\label{sec:org9b9932d}
\subsubsection{Playing cards}
\label{sec:orga70d718}
\begin{itemize}
...
\label{sec:org2369963}
\begin{enumerate}
\item Step 1
\label{sec:org6e29789}
...
\end{itemize}
\item Theorem
\label{sec:org7517349}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgf484b9f}
...
\label{sec:orgc3a5721}
\subsection{Structural Induction}
\label{sec:org23b0035}
\begin{itemize}
...
\label{sec:orgf3e2828}
\subsection{Higher-order functions}
\label{sec:orga4a3dee}
\begin{itemize}
...
\label{sec:org9eb5123}
\subsection{Lambda-Calculus}
\label{sec:orgfc7374f}
\begin{itemize}
...
\label{sec:org6d91636}
\subsection{Warm up}
\label{sec:org709cbc5}
...
\label{sec:org3757ddc}
\subsection{Demo}
\label{sec:org3a26da4}
\begin{itemize}
...
\label{sec:org237ac34}
\subsection{Exceptions}
\label{sec:org80e133a}
\begin{itemize}
...
\label{sec:org2ec012d}
\subsection{Backtracking}
\label{sec:org36a0968}
\begin{itemize}
...
\label{sec:org697d92e}
\subsection{Modules}
\label{sec:orgab04dd2}
Primary Benefits:
\begin{itemize}
...
\label{sec:org48f2771}
\subsection{More on Modules}
\label{sec:org1322106}
\begin{itemize}
