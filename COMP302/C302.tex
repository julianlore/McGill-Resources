...
\label{sec:org49347e8}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org5e40923}
\begin{itemize}
...
\label{sec:org52d2b31}
\subsection{Functions}
\label{sec:orgd62482c}
\begin{itemize}
...
\label{sec:org4b7d3bc}
\subsubsection{Playing cards}
\label{sec:org77a828a}
\begin{itemize}
...
\label{sec:org5f327a2}
\begin{enumerate}
\item Step 1
\label{sec:org4a42395}
...
\end{itemize}
\item Theorem
\label{sec:orgfd92b50}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgba269dd}
...
\label{sec:orgb8d436c}
\subsection{Structural Induction}
\label{sec:org2df63ef}
\begin{itemize}
...
\label{sec:org80f4ea3}
\subsection{Higher-order functions}
\label{sec:orgded843a}
\begin{itemize}
...
\label{sec:org8763911}
\subsection{Lambda-Calculus}
\label{sec:org698c91d}
\begin{itemize}
...
\label{sec:org54a2051}
\subsection{Warm up}
\label{sec:org41e9f1c}
...
\label{sec:org0bda2e4}
\subsection{Demo}
\label{sec:org39fe85b}
\begin{itemize}
...
\label{sec:orgc27c988}
\subsection{Exceptions}
\label{sec:orgca54c0b}
\begin{itemize}
...
\label{sec:org12c5b2e}
\subsection{Backtracking}
\label{sec:org247095a}
\begin{itemize}
...
\label{sec:org11a09fb}
\subsection{Modules}
\label{sec:org8d3bebe}
Primary Benefits:
\begin{itemize}
...
\label{sec:orgff605da}
\subsection{More on Modules}
\label{sec:org0fab84c}
\begin{itemize}
...
\label{sec:org8f16e4c}
\subsection{Continuations}
\label{sec:orga8d6c5b}
...
\label{sec:org7edf9fd}
\subsection{Continuation recap}
\label{sec:orgbf15cd7}
\begin{itemize}
...
\label{sec:org6e924a9}
\subsection{Regular expressions}
\label{sec:orgb5308d0}
...
\label{sec:orgb3cec85}
\subsection{Lazy Programming}
\label{sec:org3baa69c}
\subsubsection{Eager vs Lazy}
\label{sec:orgec97ac6}
\begin{itemize}
...
\label{sec:org6428038}
\subsection{Demo}
\label{sec:org2d1f347}
\begin{verbatim}
