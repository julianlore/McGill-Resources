...
\label{sec:orge3c844e}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org377f8f6}
\begin{itemize}
...
\label{sec:orgaec0ca0}
\subsection{Functions}
\label{sec:org6ee06a5}
\begin{itemize}
...
\label{sec:org0bb4ccc}
\subsubsection{Playing cards}
\label{sec:org6305283}
\begin{itemize}
...
\label{sec:org6b3b492}
\begin{enumerate}
\item Step 1
\label{sec:org2bc1642}
...
\end{itemize}
\item Theorem
\label{sec:org00535e9}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgb92411e}
...
\label{sec:org2b5e35a}
\subsection{Structural Induction}
\label{sec:org2f373d0}
\begin{itemize}
...
\label{sec:org49ad82f}
\subsection{Higher-order functions}
\label{sec:org78d6b6d}
\begin{itemize}
...
\label{sec:org1422723}
\subsection{Lambda-Calculus}
\label{sec:org23897cf}
\begin{itemize}
...
\label{sec:orge8039f1}
\subsection{Warm up}
\label{sec:org1885102}
...
\label{sec:org79f58f8}
\subsection{Demo}
\label{sec:orgc6d09e5}
\begin{itemize}
...
\label{sec:org5831abd}
\subsection{Exceptions}
\label{sec:org151869a}
\begin{itemize}
...
\label{sec:org63ef521}
\subsection{Backtracking}
\label{sec:org6cb1546}
\begin{itemize}
