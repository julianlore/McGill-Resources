...
\label{sec:orgff4d34a}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orge59675e}
\begin{itemize}
...
\label{sec:org7a820c4}
\subsection{Functions}
\label{sec:orgf082bb3}
\begin{itemize}
...
\label{sec:orgc52c9f4}
\subsubsection{Playing cards}
\label{sec:org12bb6be}
\begin{itemize}
...
\label{sec:org227aed8}
\begin{enumerate}
\item Step 1
\label{sec:orge7bceb1}
...
\end{itemize}
\item Theorem
\label{sec:orgc1bdca8}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org970a869}
...
\label{sec:org48bd81f}
\subsection{Structural Induction}
\label{sec:orged32acb}
\begin{itemize}
...
\label{sec:org220c646}
\subsection{Higher-order functions}
\label{sec:org452eee1}
\begin{itemize}
...
\label{sec:org981ede0}
\subsection{Lambda-Calculus}
\label{sec:org12c2e8f}
\begin{itemize}
...
\label{sec:orgf919455}
\subsection{Warm up}
\label{sec:orgca86675}
...
\label{sec:orgdb141a1}
\subsection{Demo}
\label{sec:orgf616660}
\begin{itemize}
...
\label{sec:org3749742}
\subsection{Exceptions}
\label{sec:org2f0417d}
\begin{itemize}
...
\label{sec:org1024005}
\subsection{Backtracking}
\label{sec:org3b18503}
\begin{itemize}
...
\label{sec:org9583009}
\subsection{Modules}
\label{sec:org985faa0}
Primary Benefits:
\begin{itemize}
...
\label{sec:org3c8e68b}
\subsection{More on Modules}
\label{sec:org4b9d52a}
\begin{itemize}
...
\label{sec:org0dca5cd}
\subsection{Continuations}
\label{sec:org83bc763}
