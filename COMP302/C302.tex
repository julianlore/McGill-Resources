...
\label{sec:org95671d9}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:orgdc90cb9}
\begin{itemize}
...
\label{sec:org6f9b56f}
\subsection{Functions}
\label{sec:org581ee10}
\begin{itemize}
...
\label{sec:org709a782}
\subsubsection{Playing cards}
\label{sec:org0ba8d36}
\begin{itemize}
...
\label{sec:org2d41b8c}
\begin{enumerate}
\item Step 1
\label{sec:org40beac5}
...
\end{itemize}
\item Theorem
\label{sec:orgdde1e4c}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:orgc640d95}
...
\label{sec:org4034b6a}
\subsection{Structural Induction}
\label{sec:org26755a4}
\begin{itemize}
...
\label{sec:orgefbcf49}
\subsection{Higher-order functions}
\label{sec:orge42365a}
\begin{itemize}
...
\label{sec:orgf054859}
\subsection{Lambda-Calculus}
\label{sec:org606bc07}
\begin{itemize}
