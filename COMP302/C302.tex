...
\label{sec:org0022e4b}
\begin{itemize}
\item Can do assignments in groups of 2
\end{itemize}

\subsection{Misc}
\label{sec:org13b1b82}
\begin{itemize}
...
\label{sec:orgcb237c7}
\subsection{Functions}
\label{sec:org4133cab}
\begin{itemize}
...
\label{sec:orge48ec75}
\subsubsection{Playing cards}
\label{sec:org368ac87}
\begin{itemize}
...
\label{sec:org0e2ab21}
\begin{enumerate}
\item Step 1
\label{sec:org4ae8df0}
...
\end{itemize}
\item Theorem
\label{sec:org335923f}
For all \(l, v, k\), lookup \(k\) (insert \((k,v) l\)) \(\implies *\) Some \(v\)
\item Proof
\label{sec:org3072a39}
...
\label{sec:orgd0c19a0}
\subsection{Structural Induction}
\label{sec:orga92c566}
\begin{itemize}
...
\label{sec:orgd964c3d}
\subsection{Higher-order functions}
\label{sec:orgb4a296f}
\begin{itemize}
...
\label{sec:org9ea91b5}
\subsection{Lambda-Calculus}
\label{sec:org502b854}
\begin{itemize}
...
\label{sec:org4a809da}
\subsection{Warm up}
\label{sec:org1e15e17}
...
\label{sec:org80a7407}
\subsection{Demo}
\label{sec:org9852281}
\begin{itemize}
...
\label{sec:org3907503}
\subsection{Exceptions}
\label{sec:orgbd3d3fe}
\begin{itemize}
...
\label{sec:org4e52693}
\subsection{Backtracking}
\label{sec:org7e96264}
\begin{itemize}
...
\label{sec:orgf624f80}
\subsection{Modules}
\label{sec:orgd338428}
Primary Benefits:
\begin{itemize}
...
\label{sec:orgcca3d9d}
\subsection{More on Modules}
\label{sec:org81d56a4}
\begin{itemize}
...
\label{sec:org621df1b}
\subsection{Continuations}
\label{sec:org1b07cee}
...
\label{sec:org16f0f06}
\subsection{Continuation recap}
\label{sec:org3acb23a}
\begin{itemize}
...
\label{sec:org32a3ad3}
\subsection{Regular expressions}
\label{sec:org03f326d}
...
\label{sec:org34bc96b}
\subsection{Lazy Programming}
\label{sec:org1e151da}
\subsubsection{Eager vs Lazy}
\label{sec:orgdd531c5}
\begin{itemize}
...
\label{sec:orgabaff0e}
\subsection{Demo}
\label{sec:org49398a2}
\begin{verbatim}
...
\label{sec:org3fd7cf4}
\subsection{Designing our own language}
\label{sec:org36c5321}
...
\label{sec:org4ceb0e3}
We can run it!
\subsubsection{Static Type Checking}
\label{sec:org03bd9fd}
\begin{itemize}
\item Types approximate runtime behavior
...
\label{sec:org346066a}
Continuation from last class.
\subsection{Substitution}
\label{sec:org6e0bed5}
\begin{itemize}
