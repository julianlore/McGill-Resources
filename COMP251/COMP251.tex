...
\label{sec:org955579e}
\subsection{Algorithm}
\label{sec:orgc88c40f}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:org58091cc}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orgf8cbabc}
...
\label{sec:org251ed9a}
\subsubsection{Interval scheduling}
\label{sec:orgb87e09b}
\begin{itemize}
...
\label{sec:org0b5b913}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orgbbd486b}
...
\label{sec:org6d46b94}
\subsection{Graphs}
\label{sec:org308f0db}
\subsubsection{Undirected Graphs}
\label{sec:orgef9d4ef}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:orgbb7e592}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org3e33006}
...
\label{sec:org56357f4}
\subsection{Stable Marriage}
\label{sec:org0aab337}
...
\label{sec:org51eee66}
\subsection{Graph Exploration Algorithms}
\label{sec:org35a7571}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orgb9d107d}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org8f7101e}
\begin{enumerate}
\item Theorem
\label{sec:orgb39a31b}
...
\begin{enumerate}
\item Lemma.
\label{sec:org6718121}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org56fb1da}
\begin{itemize}
...
\label{sec:org5e21331}
\subsection{Recall}
\label{sec:orgc7a6ab3}
Interval scheduling
\begin{itemize}
...
\label{sec:org777b1a6}
\subsection{Shortest Path in Graphs}
\label{sec:org0530feb}
\begin{itemize}
...
\label{sec:org1d3d98f}
\subsection{Recall}
\label{sec:org096c4fe}
...
\label{sec:org69bb5e9}
\subsection{Recall: Huffman Coding}
\label{sec:org6f5a564}
\begin{itemize}
