...
\label{sec:orga2c977f}
\subsection{Algorithm}
\label{sec:org6c300c4}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgfed4155}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:org75a3762}
...
\label{sec:org61e201d}
\subsubsection{Interval scheduling}
\label{sec:org5b03ee3}
\begin{itemize}
...
\label{sec:org09c297d}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orgd930789}
...
\label{sec:org5f9a967}
\subsection{Graphs}
\label{sec:orgdd71320}
\subsubsection{Undirected Graphs}
\label{sec:orgb6b7155}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org89b5096}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org91e5d4f}
...
\label{sec:org0b0527d}
\subsection{Stable Marriage}
\label{sec:orgb1797d0}
...
\label{sec:orgeef387c}
\subsection{Graph Exploration Algorithms}
\label{sec:orgfff1b5a}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:org7cb5e15}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:orgd547161}
\begin{enumerate}
\item Theorem
\label{sec:org6db0e78}
...
\begin{enumerate}
\item Lemma.
\label{sec:orge8c8cdb}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org95835cc}
\begin{itemize}
...
\label{sec:orgda713ee}
\subsection{Recall}
\label{sec:orge1f6044}
Interval scheduling
\begin{itemize}
...
\label{sec:org94f253e}
\subsection{Shortest Path in Graphs}
\label{sec:orgeaf4ae7}
\begin{itemize}
...
\label{sec:org256ff55}
\subsection{Recall}
\label{sec:org6702735}
...
\label{sec:org43ab322}
\subsection{Recall: Huffman Coding}
\label{sec:orgd3beae9}
\begin{itemize}
...
\label{sec:orgcc8195c}
\subsection{Integer Addition}
\label{sec:org3bd9d5f}
...
\label{sec:org41afdcd}
\subsection{Dynamic Programming}
\label{sec:orgc5d85b4}
...
\label{sec:org45c4102}
\subsection{Recall}
\label{sec:org9503b78}
Knapsack \(\Theta(nW)\)
\begin{itemize}
...
\label{sec:org7de119f}
\subsection{Longest Common Subsequence}
\label{sec:org3de13ee}
\begin{itemize}
