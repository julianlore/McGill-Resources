...
\label{sec:org8229313}
\subsection{Algorithm}
\label{sec:org685c510}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:org29a955f}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:org5cc3f00}
...
\label{sec:org6454420}
\subsubsection{Interval scheduling}
\label{sec:org22fad60}
\begin{itemize}
...
\label{sec:org5a61cf7}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orgeb6d766}
...
\label{sec:org6e22fc5}
\subsection{Graphs}
\label{sec:org2d42df1}
\subsubsection{Undirected Graphs}
\label{sec:org21fbf45}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org2d3f797}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org98747c0}
...
\label{sec:org792fc39}
\subsection{Stable Marriage}
\label{sec:org6685ffb}
...
\label{sec:org2de44a3}
\subsection{Graph Exploration Algorithms}
\label{sec:orge99f2e0}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:org48164f7}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org08d902f}
\begin{enumerate}
\item Theorem
\label{sec:org12e3363}
...
\begin{enumerate}
\item Lemma.
\label{sec:orgc47ab05}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org201ad07}
\begin{itemize}
...
\label{sec:orgd4a8042}
\subsection{Recall}
\label{sec:orged5f829}
Interval scheduling
\begin{itemize}
...
\label{sec:orgda8587f}
\subsection{Shortest Path in Graphs}
\label{sec:orgfd51dff}
\begin{itemize}
...
\label{sec:org2379ac2}
\subsection{Recall}
\label{sec:org04b2cc1}
...
\label{sec:org7e748be}
\subsection{Recall: Huffman Coding}
\label{sec:org26c6353}
\begin{itemize}
...
\label{sec:org45f1198}
\subsection{Integer Addition}
\label{sec:orgefeea07}
...
\label{sec:org4bd8e0b}
\subsection{Dynamic Programming}
\label{sec:org3f773a8}
...
\label{sec:org12c6726}
\subsection{Recall}
\label{sec:org909a117}
Knapsack \(\Theta(nW)\)
\begin{itemize}
...
\label{sec:orgb31c6e7}
\subsection{Longest Common Subsequence}
\label{sec:org8779502}
\begin{itemize}
...
\label{sec:orge8ab38d}
\subsection{Max Flow Problem}
\label{sec:org41aca1c}
