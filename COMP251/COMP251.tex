...
\end{itemize}
\item Theorem:
\label{sec:orge3604d3}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orga8090ac}
...
\label{sec:org64756d8}
\subsubsection{Interval scheduling}
\label{sec:org1d44d27}
\begin{itemize}
...
\label{sec:org78e0731}
\begin{enumerate}
\item \underline{Def:}
\label{sec:org14ac237}
...
\label{sec:org731e47e}
\subsection{Graphs}
\label{sec:orgc6c80b8}
\subsubsection{Undirected Graphs}
\label{sec:orgaee908d}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org75a9fd5}
\subsection{Stable Marriage}
\label{sec:org078204a}
...
\label{sec:org4e74e08}
\subsection{Graph Exploration Algorithms}
\label{sec:orgdec2144}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:org8c57584}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org7cefff8}
\begin{enumerate}
\item Theorem
\label{sec:org87c934a}
...
\begin{enumerate}
\item Lemma.
\label{sec:orgbaebc4f}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org814890d}
\begin{itemize}
...
\label{sec:orgdc1607a}
\subsection{Recall}
\label{sec:orgda4feec}
Interval scheduling
\begin{itemize}
...
\label{sec:org53218c0}
\subsection{Recall: Huffman Coding}
\label{sec:org2425228}
\begin{itemize}
...
\label{sec:orge812d24}
\subsection{Dynamic Programming}
\label{sec:org9ae950c}
...
\label{sec:orgf902ab1}
\subsection{Longest Common Subsequence}
\label{sec:orgcdddc80}
\begin{itemize}
...
\label{sec:org19c5cba}
\subsection{Max Flow Problem}
\label{sec:org14ebb47}
...
\label{sec:orgfe9afa9}
\subsection{Recall: Max Flow Problem}
\label{sec:orgcece124}
\begin{center}
