...
\label{sec:org46b82b4}
\subsection{Algorithm}
\label{sec:orgdda8941}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgc56a6f4}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:org50f9fd0}
...
\label{sec:org0025006}
\subsubsection{Interval scheduling}
\label{sec:org28c4eee}
\begin{itemize}
...
\label{sec:org9a4a437}
\begin{enumerate}
\item \underline{Def:}
\label{sec:org4b36b15}
...
\label{sec:orgae8066f}
\subsection{Graphs}
\label{sec:org2ccb82b}
\subsubsection{Undirected Graphs}
\label{sec:orgd1c2389}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:orgfd8b060}
\begin{enumerate}
\item Adjacency matrix
\label{sec:orgbcffbb4}
...
\label{sec:org385197e}
\subsection{Stable Marriage}
\label{sec:org32e1288}
...
\label{sec:orgab5e6e9}
\subsection{Graph Exploration Algorithms}
\label{sec:orgc1176a9}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:org029b766}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org792bdce}
\begin{enumerate}
\item Theorem
\label{sec:orge5f69d6}
...
\begin{enumerate}
\item Lemma.
\label{sec:orgbbdce21}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org6e7574e}
\begin{itemize}
...
\label{sec:org288d192}
\subsection{Recall}
\label{sec:org3b2adcf}
Interval scheduling
\begin{itemize}
...
\label{sec:org021ff1a}
\subsection{Shortest Path in Graphs}
\label{sec:org9a2da58}
\begin{itemize}
...
\label{sec:org23c616f}
\subsection{Recall}
\label{sec:org35aaaf6}
...
\label{sec:orgbb2b8c9}
\subsection{Recall: Huffman Coding}
\label{sec:org5f953bc}
\begin{itemize}
...
\label{sec:orgae06c4b}
\subsection{Integer Addition}
\label{sec:orga053323}
