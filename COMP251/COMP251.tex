...
\label{sec:org345a631}
\subsection{Algorithm}
\label{sec:org3f08bad}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgb6f826a}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:org2f1175a}
...
\label{sec:org5c4418d}
\subsubsection{Interval scheduling}
\label{sec:org3286b6b}
\begin{itemize}
...
\label{sec:org36d304c}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orgaadbad8}
...
\label{sec:org91270fe}
\subsection{Graphs}
\label{sec:org99bd08d}
\subsubsection{Undirected Graphs}
\label{sec:orgc2e97cc}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org3f44d08}
\begin{enumerate}
\item Adjacency matrix
\label{sec:orgdf38dc7}
...
\label{sec:orga305d00}
\subsection{Stable Marriage}
\label{sec:orgc5b09f4}
...
\label{sec:org53c3c41}
\subsection{Graph Exploration Algorithms}
\label{sec:org2743fe8}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orgd9de66b}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:orgc3e3bfd}
\begin{enumerate}
\item Theorem
\label{sec:org0f4d34a}
...
\begin{enumerate}
\item Lemma.
\label{sec:org0c99bb2}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org5eca747}
\begin{itemize}
...
\label{sec:org97271a4}
\subsection{Recall}
\label{sec:orgfaab070}
Interval scheduling
\begin{itemize}
...
\label{sec:org9066d52}
\subsection{Shortest Path in Graphs}
\label{sec:orgd8e2123}
\begin{itemize}
...
\label{sec:org6b0906c}
\subsection{Recall}
\label{sec:org961a35e}
...
\label{sec:orgac222af}
\subsection{Recall: Huffman Coding}
\label{sec:org75a7500}
\begin{itemize}
