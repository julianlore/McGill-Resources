...
\label{sec:org71939ae}
\subsection{Algorithm}
\label{sec:org8d2c037}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgc4b9c6b}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orga06f094}
...
\label{sec:orgeb96469}
\subsubsection{Interval scheduling}
\label{sec:org6d358d5}
\begin{itemize}
...
\label{sec:org8596e40}
\begin{enumerate}
\item \underline{Def:}
\label{sec:org55d8a99}
...
\label{sec:org1076c56}
\subsection{Graphs}
\label{sec:orgc537295}
\subsubsection{Undirected Graphs}
\label{sec:orga92fde1}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:orgee3216d}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org28e847d}
...
\label{sec:orgc35a6d2}
\subsection{Stable Marriage}
\label{sec:org9f2731b}
...
\label{sec:org08c7a0c}
\subsection{Graph Exploration Algorithms}
\label{sec:orge5ac3d2}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:org5ddbd06}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org3aa30ed}
\begin{enumerate}
\item Theorem
\label{sec:orgead0de0}
...
\begin{enumerate}
\item Lemma.
\label{sec:orga33a4f3}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org81551b3}
\begin{itemize}
...
\label{sec:orgf23b109}
\subsection{Recall}
\label{sec:org2d207f7}
Interval scheduling
\begin{itemize}
...
\label{sec:orgaf2d668}
\subsection{Shortest Path in Graphs}
\label{sec:org4963a34}
\begin{itemize}
...
\label{sec:org522c274}
\subsection{Recall}
\label{sec:org51b939d}
...
\label{sec:orgb1baddf}
\subsection{Recall: Huffman Coding}
\label{sec:orgd92d202}
\begin{itemize}
...
\label{sec:orgb130a44}
\subsection{Integer Addition}
\label{sec:org0bef61b}
...
\label{sec:orgd3b34aa}
\subsection{Dynamic Programming}
\label{sec:org5c1319c}
...
\label{sec:orgdb95648}
\subsection{Recall}
\label{sec:org0103c19}
Knapsack \(\Theta(nW)\)
\begin{itemize}
...
\label{sec:org025e34b}
\subsection{Longest Common Subsequence}
\label{sec:orgc213252}
\begin{itemize}
