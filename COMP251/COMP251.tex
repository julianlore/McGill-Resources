...
\label{sec:org630ec3d}
\subsection{Algorithm}
\label{sec:org3698abd}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:org572407e}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orgc5f6800}
...
\label{sec:org7358f03}
\subsubsection{Interval scheduling}
\label{sec:org242e68e}
\begin{itemize}
...
\label{sec:org04a3dfb}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orgd221e4a}
...
\label{sec:orgd69b2f3}
\subsection{Graphs}
\label{sec:org33100fd}
\subsubsection{Undirected Graphs}
\label{sec:org041a800}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org5d5dbec}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org72cf0be}
...
\label{sec:org846fa22}
\subsection{Stable Marriage}
\label{sec:org11d4933}
...
\label{sec:org3ba8779}
\subsection{Graph Exploration Algorithms}
\label{sec:orga5273a1}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orgaa11bdb}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org596eb23}
\begin{enumerate}
\item Theorem
\label{sec:org55636db}
