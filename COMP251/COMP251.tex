...
\label{sec:orga2d0dfc}
\subsection{Algorithm}
\label{sec:org1e0a20f}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:org89cb45c}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orgd240f67}
...
\label{sec:orgd6d3663}
\subsubsection{Interval scheduling}
\label{sec:org95cb5a6}
\begin{itemize}
...
\label{sec:orgfed9940}
\begin{enumerate}
\item \underline{Def:}
\label{sec:orga6433be}
...
\label{sec:org3807e24}
\subsection{Graphs}
\label{sec:org1879062}
\subsubsection{Undirected Graphs}
\label{sec:org7235414}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org04ee178}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org893a121}
...
\label{sec:org28d7ff4}
\subsection{Stable Marriage}
\label{sec:org7f4c680}
...
\label{sec:orgd5ee8fa}
\subsection{Graph Exploration Algorithms}
\label{sec:org97e0a93}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orge6ab6e8}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:org6806729}
\begin{enumerate}
\item Theorem
\label{sec:orgaf773b8}
...
\begin{enumerate}
\item Lemma.
\label{sec:org494b3e9}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:orge97e142}
\begin{itemize}
...
\label{sec:orgd1a3654}
\subsection{Recall}
\label{sec:org80f5882}
Interval scheduling
\begin{itemize}
...
\label{sec:org7af8cc0}
\subsection{Shortest Path in Graphs}
\label{sec:org5b0c122}
\begin{itemize}
...
\label{sec:org16d0c30}
\subsection{Recall}
\label{sec:org58e077c}
