...
\label{sec:org1b00d3c}
\subsection{Algorithm}
\label{sec:org78fe6ed}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgc2a6035}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:org90382c2}
...
\label{sec:orgeaf46b4}
\subsubsection{Interval scheduling}
\label{sec:org206e353}
\begin{itemize}
...
\label{sec:org3fdaead}
\begin{enumerate}
\item \underline{Def:}
\label{sec:org8346778}
...
\label{sec:org316070f}
\subsection{Graphs}
\label{sec:org9859e0e}
\subsubsection{Undirected Graphs}
\label{sec:orgf9221e3}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:orga202d23}
\begin{enumerate}
\item Adjacency matrix
\label{sec:org0a1b557}
...
\label{sec:orgd5152d6}
\subsection{Stable Marriage}
\label{sec:org67e2a56}
...
\label{sec:org27d7255}
\subsection{Graph Exploration Algorithms}
\label{sec:orgd982823}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orgaa694c2}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:orgc2ee8a2}
\begin{enumerate}
\item Theorem
\label{sec:org5fde2de}
...
\begin{enumerate}
\item Lemma.
\label{sec:orgbd55abe}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org9712e5c}
\begin{itemize}
...
\label{sec:orge740e03}
\subsection{Recall}
\label{sec:orge712087}
Interval scheduling
\begin{itemize}
...
\label{sec:orgbcf9c7e}
\subsection{Shortest Path in Graphs}
\label{sec:orgc3694bb}
\begin{itemize}
...
\label{sec:org271258a}
\subsection{Recall}
\label{sec:org1307fae}
...
\label{sec:orgb8f866d}
\subsection{Integer Addition}
\label{sec:org8d8b1d6}
...
\label{sec:orgf15333e}
\subsection{Dynamic Programming}
\label{sec:org5646fcf}
...
\label{sec:org0fef77a}
\subsection{Longest Common Subsequence}
\label{sec:org02d1c6d}
\begin{itemize}
...
\label{sec:orgf7af726}
\subsection{Max Flow Problem}
\label{sec:orgce955a6}
...
\label{sec:org194471b}
\subsection{Recall: Max Flow Problem}
\label{sec:orgef11310}
\begin{center}
