...
\label{sec:org2016adf}
\subsection{Algorithm}
\label{sec:orgc04dc3f}
\begin{itemize}
...
\end{itemize}
\item Theorem:
\label{sec:orgb0442da}
The final matching is stable.
\begin{enumerate}
\item Proof:
\label{sec:orge81e46b}
...
\label{sec:orgffda600}
\subsubsection{Interval scheduling}
\label{sec:org2f8435b}
\begin{itemize}
...
\label{sec:orgf04a4bb}
\begin{enumerate}
\item \underline{Def:}
\label{sec:org5f63fbc}
...
\label{sec:orgec9341f}
\subsection{Graphs}
\label{sec:org31fae8c}
\subsubsection{Undirected Graphs}
\label{sec:org16d7f43}
\begin{itemize}
\item Notation \(G=(V,E)\)
\begin{itemize}
...
\label{sec:org4ed8133}
\begin{enumerate}
\item Adjacency matrix
\label{sec:orge330716}
...
\label{sec:org38ff208}
\subsection{Stable Marriage}
\label{sec:orgb182652}
...
\label{sec:org0cdfff7}
\subsection{Graph Exploration Algorithms}
\label{sec:orgca261ca}
\subsubsection{Breadth-First-Search (BFS)}
\label{sec:orged46bd5}
\begin{center}
...
\end{itemize}
\item Algorithm
\label{sec:orgfcb8dca}
\begin{enumerate}
\item Theorem
\label{sec:org21943d8}
...
\begin{enumerate}
\item Lemma.
\label{sec:org149deaf}
For all \(r \leq k\), \(f(i_r) \leq f(j_r)\)
\begin{enumerate}
\item Proof
\label{sec:org6d1bfce}
\begin{itemize}
...
\label{sec:org62bf9f6}
\subsection{Recall}
\label{sec:org0a2cd31}
Interval scheduling
\begin{itemize}
...
\label{sec:org92a132a}
\subsection{Shortest Path in Graphs}
\label{sec:orgf2df8af}
\begin{itemize}
...
\label{sec:orgd05d687}
\subsection{Recall}
\label{sec:org0435bc8}
