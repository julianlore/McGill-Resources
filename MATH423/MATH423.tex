 ...
 \\
  ...
  \begin{align*}
    SS_R & = \sum_{i=1}^n (\hat{y}_i - \overline{y}) = \sum_{i=1}^n ((\hat{\beta}_0 + \hat{\beta}_1x_{1i}) - (\hat{\beta}_0 + \hat{\beta}_1 \overline{x}_1))^2
           = \hat{\beta}_1^2 \sum_{i=1}^n (x_{1i} - \overline{x}_1)^2 = \hat{\beta}_1^2 S_{xx}
...
\hat{m}(x_{10}) + k \sqrt{MS_{Res} \left(\frac{1}{n} + \frac{(x_{10} - \overline{x}_1)^2}{S_{xx}}\right)}
    ...
    \begin{itemize}
    \item A $100 (1- \alpha)\%$ CI on the mean response is an interval
      $[l, u]$ where
      \begin{align*}
    ...
    \item A $100 (1-\alpha)\%$ CI on the new observation $Y$ is an
      interval $[l', u']$ where
      \begin{align*}
