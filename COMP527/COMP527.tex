...
\begin{document}
    ...
    \begin{center}
      ...
      \DP
    \begin{tabular}{c}
      $\mathcal{E}$\\ $\Longrightarrow B$ true
    \end{tabular}
    \end{center}
    ...
    \begin{center}
    \begin{tabular}{c}
      $\mathcal{D}$ \\ $A \land B$ true $\Longrightarrow$
    \end{tabular}
    \AXC{$\mathcal{D}$}
    \noLine
    \UIC{$A \land B$ true}
    ...
    want to introduce the rule and then eliminate it and showing that
    ...
    \begin{center}
      ...
      \DP
      \begin{tabular}{c}
        $\Longrightarrow [\mathcal{E}/u, C/p]D$
        \\ $C$ true
      \end{tabular}
    \end{center}
    \paragraph{Local Completeness}
