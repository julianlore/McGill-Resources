...
\end{verbatim}
       ...
       \begin{prooftree}
         ...
         \BIC{$\Gamma \vdash nor (x.M_1) (y.M_2) : A$}
       \end{prooftree}
       \begin{prooftree}
       ...
       \begin{center}
         ...
         \AXC{}
         \RL{}
         \UIC{$\Gamma, y:A_1 \vdash y:A_2$}
         \BIC{$\Gamma ,y:A_2 \vdash abort_R\ M_0\ y :q$}
         \RL{$\overline{\lor}$ I$^{x,y, p, q}$}
         \BIC{$\Gamma \vdash nor (x.abort_L\ M_o\ x) : A_1 \overline{\lor} A_2$}
         \DP}
       \end{center}
       ...
       \begin{prooftree}
         \AXC{$\Gamma, x:A_1 \vdash M_1 : p$}
         \AXC{$\Gamma, y:A_2 \vdash M_2 : q$}
         \BIC{$\Gamma \vdash nor (x:A_1.M_1) (y:A_2.M_2) : A$}
       \end{prooftree}
