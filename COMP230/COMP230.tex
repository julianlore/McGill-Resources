...
\label{sec:org4dba572}
\begin{enumerate}
\item Thm
\label{sec:org2dc2590}
...
\label{sec:org002e416}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:org28860fe}
...
\label{sec:org69e6838}
\begin{enumerate}
\item Claim
\label{sec:orgf187b95}
...
\label{sec:org14d68eb}
\subsection{Set theory}
\label{sec:orgcdd4cf3}
...
\label{sec:org3f95f21}
\subsection{Recap}
\label{sec:orga4d989a}
...
\label{sec:orgc944ec5}
\subsubsection{Cardinalities}
\label{sec:org05c8188}
...
\label{sec:org095c2f3}
\subsubsection{Examples}
\label{sec:orgcbdb010}
\begin{itemize}
...
\label{sec:orgb6abbef}
\subsection{Quiz prep}
\label{sec:orgc817341}
\begin{itemize}
...
\label{sec:orgf20a821}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org98c8389}
...
\label{sec:org054dac0}
\subsection{Quiz review}
\label{sec:orgbd85085}
\begin{itemize}
...
\label{sec:org238aa8d}
\subsection{Theorems}
\label{sec:org91088ea}
...
\label{sec:org8d8cb79}
\subsection{Propositional Logic}
\label{sec:org96e4f8e}
...
\label{sec:orgfbf1960}
\subsection{Natural Deduction}
\label{sec:org1221359}
\begin{itemize}
...
\label{sec:orgfdf0d4c}
\subsection{Recap}
\label{sec:orgcd6d5c4}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
...
\label{sec:org8acae0a}
\subsubsection{Ex.}
\label{sec:org948504a}
