...
\label{sec:org9bf3e1e}
\begin{enumerate}
\item Thm
\label{sec:orga24420f}
...
\label{sec:org7a2c2ff}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:orgb6bc476}
...
\label{sec:orgb9ca7e6}
\begin{enumerate}
\item Claim
\label{sec:org8e66b1b}
...
\label{sec:org495a669}
\subsection{Set theory}
\label{sec:org4654751}
...
\label{sec:org9996b57}
\subsection{Recap}
\label{sec:org1ebf941}
...
\label{sec:org9a4e478}
\subsubsection{Cardinalities}
\label{sec:orgdf84cb8}
...
\label{sec:orgf82ccbf}
\subsubsection{Examples}
\label{sec:org7cc50c4}
\begin{itemize}
...
\label{sec:orgc38a2b9}
\subsection{Quiz prep}
\label{sec:orgc872cb8}
\begin{itemize}
...
\label{sec:orgdb8a23b}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:orgb7a12f1}
...
\label{sec:orgab7cafa}
\subsection{Quiz review}
\label{sec:orgaeaa11b}
\begin{itemize}
...
\label{sec:orgc0d8e93}
\subsection{Theorems}
\label{sec:org455dd71}
...
\label{sec:org2f7dd5c}
\subsection{Propositional Logic}
\label{sec:org469d92e}
...
\label{sec:orgcfbbdb7}
\subsection{Natural Deduction}
\label{sec:org05f9e81}
\begin{itemize}
...
\label{sec:org7f67b06}
\subsection{Recap}
\label{sec:orgb5744ff}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
...
\label{sec:orga643e29}
\subsubsection{Ex.}
\label{sec:orgb9122a0}
...
\label{sec:org08d5711}
\subsection{Quiz Review}
\label{sec:org0491391}
\begin{itemize}
...
\label{sec:orgbdddaba}
\subsection{MIU}
\label{sec:orgc83e24e}
...
\label{sec:org0503986}
\subsection{Turing Machines}
\label{sec:orgd9960d5}
\begin{itemize}
...
\label{sec:org7f5cc7c}
\subsection{Bloop}
\label{sec:org24d313b}
...
\label{sec:org613d708}
\subsection{Quiz Review}
\label{sec:org20f2766}
\begin{itemize}
...
\label{sec:org048b4e5}
\subsection{Summary of G1}
\label{sec:org1b7ed4a}
...
\end{itemize}
\subsubsection{Thm}
\label{sec:org6069354}
If TNT is consistent, then TNT \(\nvdash CONS_{TNT}\)
\subsubsection{Proof}
\label{sec:orgce3b3bb}
