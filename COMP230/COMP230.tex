...
\label{sec:orgc328c36}
\begin{enumerate}
\item Thm
\label{sec:orgbf0ea9c}
...
\label{sec:orgbc3e2db}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:org6d5b7ef}
...
\label{sec:org46bd5a0}
\begin{enumerate}
\item Claim
\label{sec:orgcdd7b94}
...
\label{sec:orge591fa8}
\subsection{Set theory}
\label{sec:org45fe509}
...
\label{sec:org2f37bc1}
\subsection{Recap}
\label{sec:org90cc015}
...
\label{sec:orgd7e299a}
\subsubsection{Cardinalities}
\label{sec:orgb5c3fce}
...
\label{sec:orgd207aa0}
\subsubsection{Examples}
\label{sec:org424e3a8}
\begin{itemize}
...
\label{sec:orgacd3a1a}
\subsection{Quiz prep}
\label{sec:orgbcfe9c3}
\begin{itemize}
...
\label{sec:orgcfb7445}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org6677f1c}
...
\label{sec:org65de0df}
\subsection{Quiz review}
\label{sec:org5d5bcba}
\begin{itemize}
...
\label{sec:orga2dcc95}
\subsection{Theorems}
\label{sec:orge9a2071}
...
\label{sec:orgf1ae4d2}
\subsection{Propositional Logic}
\label{sec:orge09b6b3}
...
\label{sec:orgb15e418}
\subsection{Natural Deduction}
\label{sec:orgcbb6089}
\begin{itemize}
...
\label{sec:org52b97c6}
\subsection{Recap}
\label{sec:orgdbed79e}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
\item It is impossible for \$B4 to be false and \(A\) and \(A\supset B\) to be true.
\end{itemize}
...
\end{enumerate}
\item 1 \& 2 are base clauses, 3 is the inductive clause. This is a recursive definition. Since proofs are defined inductively, we can proof things about proofs using induction.
\end{itemize}
...
\label{sec:orgc8757ff}
\subsubsection{Ex.}
\label{sec:org36261cd}
...
\label{sec:org5aeeb52}
If \(\Gamma\) is a set of wff and \(A\) wff then:
\begin{itemize}
\item If \(\Gamma \vdash A\), then \(\Gamma \models A\)
\item To show, show that all axioms are tautologies and we know the modus ponens is a semantic consequence as well.
\end{itemize}
...
\item \(0=(x_1+x_2)\)
\item \(\sim(0 = (x_1+x_2))\)
\item \((x_1 = x_2) \supset \sim(O = (x_1+x_2))\)
...
\item \$\texttimes{}\(^{\sigma}\)=\(\sigma\)(x)=\$mult, shows what \(\times\) maps to in mapping \(\sigma\)
\end{itemize}
\end{itemize}
\end{itemize}
\item Truth in a structure (Tarski 1933)
\label{sec:org8bf2965}
