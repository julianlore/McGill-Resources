...
\label{sec:orgac0459f}
\begin{enumerate}
\item Thm
\label{sec:org4c2c310}
...
\label{sec:org4ae8e73}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:orga2369da}
...
\label{sec:orgdb847f7}
\begin{enumerate}
\item Claim
\label{sec:orgfa362df}
...
\label{sec:org73e4043}
\subsection{Set theory}
\label{sec:org6f650dc}
...
\label{sec:org3cd00cf}
\subsection{Recap}
\label{sec:org3a88108}
...
\label{sec:org335c1c4}
\subsubsection{Cardinalities}
\label{sec:org5a374da}
...
\label{sec:orgab085ae}
\subsubsection{Examples}
\label{sec:org045d79f}
\begin{itemize}
...
\label{sec:orge84f357}
\subsection{Quiz prep}
\label{sec:orgce8da03}
\begin{itemize}
...
\label{sec:orgd6f0d6c}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org08598d5}
...
\label{sec:org422abbe}
\subsection{Quiz review}
\label{sec:orgdba6a7f}
\begin{itemize}
...
\label{sec:org6f4a0db}
\subsection{Theorems}
\label{sec:org265cb1a}
...
\label{sec:orgad03cc0}
\subsection{Propositional Logic}
\label{sec:org720693a}
...
\label{sec:org95240dc}
Introduced by Gentzen, 1934.

\(\frac{\text{Premises}}{\text{Conclusion}}\)
\begin{itemize}
\item \(\frac{A \ A \supset B}{B}\)
\end{itemize}
\end{enumerate}
\end{document}