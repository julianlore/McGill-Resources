...
\label{sec:org8cfee63}
\begin{enumerate}
\item Thm
\label{sec:org6c72ebf}
...
\label{sec:org207fc5e}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:org5ff3042}
...
\label{sec:org358373a}
\begin{enumerate}
\item Claim
\label{sec:org423a2dc}
...
\label{sec:orgfcee0a9}
\subsection{Set theory}
\label{sec:org1f38a91}
...
\label{sec:org904fd5d}
\subsection{Recap}
\label{sec:org3d3aad5}
...
\label{sec:orgc3a4cd0}
\subsubsection{Cardinalities}
\label{sec:org569b07f}
...
\label{sec:org3c0048b}
\subsubsection{Examples}
\label{sec:orgb7459ae}
\begin{itemize}
...
\label{sec:org17a3d09}
\subsection{Quiz prep}
\label{sec:org94898e8}
\begin{itemize}
...
\label{sec:org959a54b}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org6da4ab2}
...
\label{sec:org8c0ad7d}
\subsection{Quiz review}
\label{sec:org0eeb13b}
\begin{itemize}
...
\label{sec:orgabe5c41}
\subsection{Theorems}
\label{sec:orgc0a9d76}
...
\label{sec:orgf6b2a20}
\subsection{Propositional Logic}
\label{sec:orgf3e7b33}
...
\label{sec:org1aa5d93}
\subsection{Natural Deduction}
\label{sec:org750f756}
\begin{itemize}
...
\label{sec:orga743602}
\subsection{Recap}
\label{sec:orgb3ae4ea}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
...
\label{sec:orgc6f9606}
\subsubsection{Ex.}
\label{sec:org1b1b31d}
...
\label{sec:org164f288}
\subsection{Quiz Review}
\label{sec:org3b742c4}
\begin{itemize}
...
\label{sec:orgac15e26}
\subsection{MIU}
\label{sec:org29024f6}
...
\end{tabular}
\end{center}
MON is a predicate standing for the MIU-producible numbers.   
\end{document}