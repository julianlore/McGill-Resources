...
\label{sec:org0bc9a91}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:org7f707b0}
...
\label{sec:org93475ab}
\begin{enumerate}
\item Claim
\label{sec:org940c682}
...
\label{sec:org2e7b83d}
\subsection{Set theory}
\label{sec:org0ba93a1}
...
\label{sec:orgc0bfebc}
\subsection{Recap}
\label{sec:orgd850baa}
...
\label{sec:org90a4481}
\subsubsection{Cardinalities}
\label{sec:orge440e2a}
...
\label{sec:org9e1c0cd}
\subsubsection{Examples}
\label{sec:orgc8e76e0}
\begin{itemize}
...
\label{sec:org9a7550f}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org01e78ed}
...
\label{sec:org28cc652}
\subsection{Theorems}
\label{sec:org3ad5b5a}
...
\label{sec:orgdb7d2d2}
\subsection{Propositional Logic}
\label{sec:org8f22b93}
...
\label{sec:org24b8d21}
\subsection{Natural Deduction}
\label{sec:org2ded4f7}
\begin{itemize}
...
\label{sec:org053b62c}
\subsection{Recap}
\label{sec:org367ce47}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
...
\label{sec:orgdf29403}
\subsubsection{Ex.}
\label{sec:orgf2830c7}
...
\label{sec:org704ad79}
\subsection{Quiz Review}
\label{sec:org46df72d}
\begin{itemize}
...
\label{sec:orge5613fc}
\subsection{MIU}
\label{sec:orgc787e76}
...
\label{sec:orgda48f31}
\subsection{Turing Machines}
\label{sec:org2950f9d}
\begin{itemize}
...
\label{sec:org796c545}
\subsection{Bloop}
\label{sec:org7260dc8}
...
\label{sec:orgd3ff207}
\subsection{Quiz Review}
\label{sec:orgb9bbace}
\begin{itemize}
...
\label{sec:org5af581b}
\subsection{Summary of G1}
\label{sec:orgba42984}
...
\end{itemize}
\subsubsection{Thm}
\label{sec:orgd1d7d8e}
If TNT is consistent, then TNT \(\nvdash CONS_{TNT}\)
\subsubsection{Proof}
\label{sec:org0c984cb}
