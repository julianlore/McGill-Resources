...
\label{sec:org29caf42}
\begin{enumerate}
\item Thm
\label{sec:org88b01a2}
...
\label{sec:orgc2f3bfc}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:orga6d1bde}
...
\label{sec:orgffa1ee2}
\begin{enumerate}
\item Claim
\label{sec:orgfea80e3}
...
\label{sec:org7f64c7f}
\subsection{Set theory}
\label{sec:org41294e7}
...
\label{sec:org49075b1}
\subsection{Recap}
\label{sec:org375efa0}
...
\label{sec:org56cde8f}
\subsubsection{Cardinalities}
\label{sec:org087c7bb}
...
\label{sec:orgb7be9e1}
\subsubsection{Examples}
\label{sec:org5af7415}
\begin{itemize}
...
\label{sec:org30608c0}
\subsection{Quiz prep}
\label{sec:orgac0cb0a}
\begin{itemize}
...
\label{sec:org79640ef}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:org1d7ff66}
...
\label{sec:org9d6cc50}
\subsection{Quiz review}
\label{sec:orgd50ef9f}
\begin{itemize}
...
\label{sec:org7c2f749}
\subsection{Theorems}
\label{sec:orgac430ed}
...
\label{sec:org352ae0b}
\subsection{Propositional Logic}
\label{sec:org0b92fe2}
...
\label{sec:org08bb515}
\subsection{Natural Deduction}
\label{sec:org1b51637}
\begin{itemize}
...
\label{sec:orgf5792be}
\subsection{Recap}
\label{sec:org613663c}
\begin{itemize}
\item A, A \(\supset\) B \(\models\) B
\begin{itemize}
...
\label{sec:org0a57d06}
\subsubsection{Ex.}
\label{sec:orgd4187c4}
...
\label{sec:orgf5d5e46}
\subsection{Quiz Review}
\label{sec:org9daa903}
\begin{itemize}
...
\label{sec:org8baf9c7}
\subsection{MIU}
\label{sec:org7d5906e}
...
\label{sec:org3ec98c4}
\subsection{Turing Machines}
\label{sec:orgf802234}
\begin{itemize}
...
\label{sec:org6cc7b2c}
\subsection{Bloop}
\label{sec:org6b1221c}
...
\label{sec:org85f8430}
\subsection{Quiz Review}
\label{sec:org0ec1a88}
\begin{itemize}
...
\label{sec:org1179a94}
\subsection{Summary of G1}
\label{sec:orga91b241}
...
\end{itemize}
\subsubsection{Thm}
\label{sec:org3546687}
If TNT is consistent, then TNT \(\nvdash CONS_{TNT}\)
\subsubsection{Proof}
\label{sec:orgba8eb2b}
