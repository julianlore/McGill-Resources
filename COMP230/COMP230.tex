...
\label{sec:org1196244}
\begin{enumerate}
\item Thm
\label{sec:org4266094}
...
\label{sec:org3d9741f}
\end{enumerate}
\section{Lecture 2 \textit{<2017-09-07 Thu>}}
\label{sec:org0e42e74}
...
\label{sec:org184ad5a}
\begin{enumerate}
\item Claim
\label{sec:org0394d9c}
...
\label{sec:org802b60b}
\subsection{Set theory}
\label{sec:org79e0fd7}
...
\label{sec:org566c9bb}
\subsection{Recap}
\label{sec:orga9fdd03}
...
\label{sec:org57ad4a4}
\subsubsection{Cardinalities}
\label{sec:orgeb1c4da}
...
\label{sec:org954509a}
\subsubsection{Examples}
\label{sec:org06c7bca}
\begin{itemize}
...
\label{sec:org6e049e0}
\subsection{Quiz prep}
\label{sec:orgcea3d2b}
\begin{itemize}
...
\label{sec:org9bd5cb7}
Theorem: There are infinitely many prime numbers.

\subsubsection{Proof (by contradiction):}
\label{sec:orgc458a98}
...
\label{sec:orga163054}
\subsection{Quiz review}
\label{sec:org568498c}
\begin{itemize}
...
\label{sec:org0f0c208}
\subsection{Theorems}
\label{sec:org7610734}
...
\label{sec:orga5dbe1e}
\subsection{Propositional Logic}
\label{sec:org855aeb0}
...
\label{sec:org0ed5636}
\subsection{Natural Deduction}
\label{sec:orgbd8fe8b}
\begin{itemize}
...
\label{sec:org32e9b16}
\subsubsection{Ex.}
\label{sec:orgf13c47d}
...
\label{sec:org3bcb3d5}
\subsection{Quiz Review}
\label{sec:orga6947c3}
\begin{itemize}
...
\label{sec:org6bab802}
\subsection{MIU}
\label{sec:org0679c86}
...
\label{sec:org0cb3334}
\subsection{Turing Machines}
\label{sec:org37c297b}
\begin{itemize}
...
\label{sec:org6557c15}
\subsection{Bloop}
\label{sec:orge1fd0c8}
...
\label{sec:org932905e}
\subsection{Quiz Review}
\label{sec:org4b73fe0}
\begin{itemize}
...
\label{sec:org26c8539}
\subsection{Summary of G1}
\label{sec:org6dfd901}
...
\begin{itemize}
\item NEG\((x,y) \iff x\) is the G$\backslash$"odel \# of wff, \(y\) is the G$\backslash$"odel \# of \(\sim A\). These two numbers code an inconsistent pair.
...
\end{itemize}
\subsubsection{Thm}
\label{sec:org8313ccf}
If TNT is consistent, then TNT \(\nvdash CONS_{TNT}\)
\subsubsection{Proof}
\label{sec:org425701c}
