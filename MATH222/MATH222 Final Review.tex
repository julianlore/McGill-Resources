...
\begin{defn}
  Let $z=f(x,y)$ be the surface $s$. Let $p=f(x_0,y_0,z_0)$ be a point on $s$, and let $\underline{u}=\langle a, b \rangle $ be any unit vector. The \mathbf{directional derivative} of $f$ in direction $\underline{u}$ at $(x_0,y_0)$ is
